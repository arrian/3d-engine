...
extern "C" int bindLua(lua_State* L)
{
  ...
  module(L)
    [
      ...
      .def("removeItem",         (std::shared_ptr<Item>(Scene::*)(Id<Item>))&Scene::remove<Item>)
      .def("removeArchitecture", (std::shared_ptr<Architecture>(Scene::*)(Id<Architecture>))&Scene::remove<Architecture>)
      .def("removeCreature",     (std::shared_ptr<Creature>(Scene::*)(Id<Creature>))&Scene::remove<Creature>)
      .def("removeInteractive",  (std::shared_ptr<Interactive>(Scene::*)(Id<Interactive>))&Scene::remove<Interactive>)
      .def("removeLight",        (std::shared_ptr<Light>(Scene::*)(Id<Light>))&Scene::remove<Light>)
      .def("removePlayer",       (std::shared_ptr<Player>(Scene::*)(Id<Player>))&Scene::remove<Player>)
      .def("removePortal",       (std::shared_ptr<Portal>(Scene::*)(Id<Portal>))&Scene::remove<Portal>)
